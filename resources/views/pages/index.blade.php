                            ...
                            <div class="header-top-left">
                                <ul>
                                    ...
                                    <li class="header-top-currency">
                                        <div class="dropdown">
                                            <button class="dropdown-toggle" type="button" id="dropdownMenuButton3" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">USD - US Dollar</button>
                                            <div class="dropdown-menu" aria-labelledby="dropdownMenuButton3">
                                                <a class="dropdown-item" href="/">INR - IN Rupe</a>
                                                <a class="dropdown-item" href="/">BDT - BD Taka</a>
                                                <a class="dropdown-item" href="/">SAR - SA Riyal</a>
                                            </div>
                                        </div>
                                    </li>
                                            ...
                                            <div class="header-cart-wrap">
                                                ...
                                                <ul class="minicart">
                                                    <li class="d-flex align-items-start">
                                                        <div class="cart-img">
                                                            <a href="/shop-details"><img src="img/product/cart_p01.jpg" alt=""></a>
                                                        </div>
                                                    ...
                                                    <li class="d-flex align-items-start">
                                                        <div class="cart-img">
                                                            <a href="/shop-details"><img src="img/product/cart_p02.jpg" alt=""></a>
                                                        </div>
                                                        <div class="cart-content">
                                                            <h4><a href="/shop-details">Organic Fresh Nuts Vanla Butter</a></h4>
                                                            <div class="cart-price">
                                                                <span class="new">$229.9</span>
                                                                <span><del>$229.9</del></span>
                                                            </div>
                                ...
                                <nav class="menu-nav">
                                    ...
                                    <div class="header-category d-none d-lg-block">
                                        ...
                                        <ul class="category-menu">
                                            <li class="menu-item-has-children"><a href="/shop"><i class="flaticon-groceries"></i> Grocery & Frozen</a>
                                                <ul class="megamenu">
                                                    <li class="sub-column-item"><a href="/shop">Grocery & Frozen</a>
                                                        <ul>
                                                            <li><a href="/shop">Organic Broccoli</a></li>
                                                            <li><a href="/shop">Walnuts Max</a></li>
                                                            <li><a href="/shop">Mat Orange</a></li>
                                                            <li><a href="/shop">France Potato</a></li>
                                                        </ul>
                                                    </li>
                                                    <li class="sub-column-item"><a href="/shop">Organic Fresh Fruits</a>
                                                        <ul>
                                                            <li><a href="/shop">Watermelon</a></li>
                                                            <li><a href="/shop">Black Grapes</a></li>
                                                            <li><a href="/shop">Grassland Dairy</a></li>
                                                            <li><a href="/shop">Organic Broccoli</a></li>
                                                        </ul>
                                                    </li>
                                                    <li class="sub-column-item"><a href="/shop">Fresh Bread & Bakery</a>
                                                        <ul>
                                                            <li><a href="/shop">Grassland Dairy</a></li>
                                                            <li><a href="/shop">Walnuts Max</a></li>
                                                            <li><a href="/shop">Powders Dairy</a></li>
                                                            <li><a href="/shop">Ice cream</a></li>
                                                        </ul>
                                                    </li>
                                                    <li class="sub-column-item"><a href="/shop">Organic Fresh Meat</a>
                                                        <ul>
                                                            <li><a href="/shop">Fresh Butter</a></li>
                                                            <li><a href="/shop">Orange Sliced</a></li>
                                                            <li><a href="/shop">Carrots Group</a></li>
                                                            <li><a href="/shop">Poultry Farm</a></li>
                                                        </ul>
                                                    </li>
                                                    <li class="sub-column-item"><a href="/shop">Organic Dried Fruit</a>
                                                        <ul>
                                                            <li><a href="/shop">Fresh Nuts</a></li>
                                                            <li><a href="/shop">France Potato</a></li>
                                                            <li><a href="/shop">Green Chilies</a></li>
                                                            <li><a href="/shop">Organic Broccoli</a></li>
                                                        </ul>
                                                    </li>
                                                    <li class="sub-column-item"><a href="/shop">Organic Other Foods</a>
                                                        <ul>
                                                            <li class="mega-menu-banner"><a href="/shop"><img src="img/images/megamenu_banner.jpg" alt=""></a></li>
                                                        </ul>
                                                    </li>
                                                </ul>
                                            </li>
                                            <li><a href="/shop"><i class="flaticon-cherry"></i> Fresh Fruits</a></li>
                                            <li><a href="/shop"><i class="flaticon-fish"></i> Fresh Fish</a></li>
                                            <li class="menu-item-has-children"><a href="/shop"><i class="flaticon-hazelnut"></i> Fresh Nuts</a>
                                                <ul class="megamenu">
                                                    <li class="sub-column-item"><a href="/shop">Grocery & Frozen</a>
                                                        <ul>
                                                            <li><a href="/shop">Organic Broccoli</a></li>
                                                    ...
                                                    <li class="sub-column-item"><a href="/shop">Organic Other Foods</a>
                                                        <ul>
                                                            <li class="mega-menu-banner"><a href="/shop"><img src="img/images/megamenu_banner02.jpg" alt=""></a></li>
                                                        </ul>
                                                    </li>
                                                </ul>
                                            </li>
                                            <li><a href="/shop"><i class="flaticon-meat"></i> Fresh Meat</a></li>
                                            <li class="menu-item-has-children"><a href="/shop"><i class="flaticon-cupcake"></i> Bread & Bakery</a>
                                                <ul class="megamenu">
                                                    <li class="sub-column-item"><a href="/shop">Grocery & Frozen</a>
                                                        <ul>
                                                            <li><a href="/shop">Organic Broccoli</a></li>
                                            ...
                                            <li><a href="/shop"><i class="flaticon-broccoli"></i> Vegetable</a></li>
                                            <li><a href="/shop"><i class="flaticon-pop-corn-1"></i> Popcorn</a></li>
                                            <li><a href="/shop"><i class="flaticon-nut"></i> Dried Fruit</a></li>
                                        </ul>
                                    </div>
                                    <div class="navbar-wrap main-menu d-none d-lg-flex">
                                        <ul class="navigation">
                                            <li class="active menu-item-has-children"><a href="/">Home</a>
                                                <ul class="submenu">
                                                    <li class="active"><a href="/">Home Page One</a></li>
                                                    <li><a href="/index-2">Home Page Two</a></li>
                                                </ul>
                                            </li>
                                            <li><a href="/about">About Us</a></li>
                                            <li><a href="/shop">Fruits & Vegetables</a></li>
                                            <li><a href="/grocery">Grocery & Staples</a></li>
                    ...
                    <div class="row">
                            ...
                            <div class="slider-active">
                                <div class="single-slider slider-bg" data-background="img/slider/slider_bg01.jpg">
                                    <div class="slider-content">
                                        ...
                                        <a href="/shop" class="btn rounded-btn" data-animation="fadeInUp" data-delay=".8s">Shop Now</a>
                                    </div>
                                </div>
                                <div class="single-slider slider-bg" data-background="img/slider/slider_bg01.jpg">
                                    <div class="slider-content">
                        ...
                        <div class="col-3">
                            <div class="slider-banner-img mb-20">
                                <a href="/shop"><img src="img/slider/slider_banner01.jpg" alt=""></a>
                            </div>
                            <div class="slider-banner-img">
                                <a href="/shop"><img src="img/slider/slider_banner02.jpg" alt=""></a>
                            </div>
                        </div>
                        <div class="col-3">
                            <div class="slider-banner-img">
                                <a href="/shop"><img src="img/slider/slider_banner03.jpg" alt=""></a>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="row category-active">
                            <div class="col-lg-2">
                                <div class="category-item active">
                                    <a href="/shop" class="category-link"></a>
                    ...
                    <div class="row justify-content-center">
                        <div class="col-xl-4 col-lg-6 col-md-8">
                            <div class="discount-item mb-20">
                                ...
                                <div class="discount-content">
                                    ...
                                    <h4 class="title"><a href="/shop">100 organic UP TO 35%</a></h4>
                        ...
                        <div class="col-xl-4 col-lg-6 col-md-8">
                            <div class="discount-item mb-20">
                                ...
                                <div class="discount-content">
                                    <span>healthy food</span>
                                    <h4 class="title"><a href="/shop">Hygienically Packed</a></h4>
                                    <a href="/shop" class="btn">shop now</a>
                                </div>
                            </div>
                        </div>
                        <div class="col-xl-4 col-lg-6 col-md-8">
                            <div class="discount-item style-two mb-20">
                                ...
                                <div class="discount-content">
                                    <span>healthy food</span>
                                    <h4 class="title"><a href="/shop">baby favorite UP TO 15%</a></h4>
                                    <a href="/shop" class="btn">shop now</a>
                                </div>
                            </div>
                        </div>
                ...
                <div class="container">
                    ...
                    <div class="row best-deal-active">
                        <div class="col-xl-3">
                            <div class="best-deal-item">
                                <div class="best-deal-thumb">
                                    <a href="/shop-details"><img src="img/product/best_deal_product01.png" alt=""></a>
                                </div>
                                <div class="best-deal-content">
                                    <div class="main-content">
                                        ...
                                        <h4 class="title"><a href="/shop-details">Walnuts Max</a></h4>
                                        <p>$1.50/ kg</p>
                                    </div>
                                    <div class="icon"><a href="/shop-details">+</a></div>
                                </div>
                            </div>
                        </div>
                        <div class="col-xl-3">
                            <div class="best-deal-item">
                                <div class="best-deal-thumb">
                                    <a href="/shop-details"><img src="img/product/best_deal_product02.png" alt=""></a>
                                </div>
                                <div class="best-deal-content">
                                    <div class="main-content">
                                        <div class="rating">
                                        ...
                                        <h4 class="title"><a href="/shop-details">Fresh Nuts</a></h4>
                                        <p>$3.50/ kg</p>
                                    </div>
                                    <div class="icon"><a href="/shop-details">+</a></div>
                                </div>
                        ...
                        <div class="col-xl-3">
                            <div class="best-deal-item">
                                <div class="best-deal-thumb">
                                    <a href="/shop-details"><img src="img/product/best_deal_product03.png" alt=""></a>
                                </div>
                                <div class="best-deal-content">
                                    <div class="main-content">
                                        <div class="rating">
                                        ...
                                        <h4 class="title"><a href="/shop-details">Fresh Butter</a></h4>
                                        <p>$5.50/ kg</p>
                                    </div>
                                    <div class="icon"><a href="/shop-details">+</a></div>
                                </div>
                        ...
                        <div class="col-xl-3">
                            <div class="best-deal-item">
                                <div class="best-deal-thumb">
                                    <a href="/shop-details"><img src="img/product/best_deal_product04.png" alt=""></a>
                                </div>
                                <div class="best-deal-content">
                                    <div class="main-content">
                                        <div class="rating">
                                        ...
                                        <h4 class="title"><a href="/shop-details">Mat Orange</a></h4>
                                        <p>$9.00/ kg</p>
                                    </div>
                                    <div class="icon"><a href="/shop-details">+</a></div>
                                </div>
                        ...
                        <div class="col-xl-3">
                            <div class="best-deal-item">
                                <div class="best-deal-thumb">
                                    <a href="/shop-details"><img src="img/product/best_deal_product05.png" alt=""></a>
                                </div>
                                <div class="best-deal-content">
                                    <div class="main-content">
                                        <div class="rating">
                                        ...
                                        <h4 class="title"><a href="/shop-details">France Potato</a></h4>
                                        <p>$3.99/ kg</p>
                                    </div>
                                    <div class="icon"><a href="/shop-details">+</a></div>
                                </div>
                                ...
                                <div class="row justify-content-center">
                                    <div class="col-xl-3 col-md-4 col-sm-6">
                                        <div class="sp-product-item mb-20">
                                            <div class="sp-product-thumb">
                                                ...
                                                <a href="/shop-details"><img src="img/product/sp_products01.png" alt=""></a>
                                            </div>
                                            <div class="sp-product-content">
                                                ...
                                                <h6 class="title"><a href="/shop-details">Uncle Bens Vanla Ready Pice</a></h6>
                                    ...
                                    <div class="col-xl-3 col-md-4 col-sm-6">
                                        <div class="sp-product-item mb-20">
                                            <div class="sp-product-thumb">
                                                ...
                                                <a href="/shop-details"><img src="img/product/sp_products02.png" alt=""></a>
                                            </div>
                                            <div class="sp-product-content">
                                                <div class="rating">
                                                    <i class="fas fa-star"></i>
                                                ...
                                                <h6 class="title"><a href="/shop-details">Dannon Max Vanla ice cream</a></h6>
                                                <span class="product-status">IN Stock</span>
                                                <div class="sp-cart-wrap">
                                                    <form action="#">
                                                        <div class="cart-plus-minus">
                                    ...
                                    <div class="col-xl-3 col-md-4 col-sm-6">
                                        <div class="sp-product-item mb-20">
                                            <div class="sp-product-thumb">
                                                ...
                                                <a href="/shop-details"><img src="img/product/sp_products03.png" alt=""></a>
                                            </div>
                                            <div class="sp-product-content">
                                                <div class="rating">
                                                    <i class="fas fa-star"></i>
                                                ...
                                                <h6 class="title"><a href="/shop-details">Walnuts Max Vanla Greek Pice</a></h6>
                                                <span class="product-status">IN Stock</span>
                                                <div class="sp-cart-wrap">
                                                    <form action="#">
                                                        <div class="cart-plus-minus">
                                    ...
                                    <div class="col-xl-3 col-md-4 col-sm-6">
                                        <div class="sp-product-item mb-20">
                                            <div class="sp-product-thumb">
                                                <span class="batch">new</span>
                                                <a href="/shop-details"><img src="img/product/sp_products04.png" alt=""></a>
                                            </div>
                                            <div class="sp-product-content">
                                                <div class="rating">
                                                    <i class="fas fa-star"></i>
                                                ...
                                                <h6 class="title"><a href="/shop-details">Brachs Bens Vanla Ready Pice</a></h6>
                                                <span class="product-status">IN Stock</span>
                                                <div class="sp-cart-wrap">
                                                    <form action="#">
                                                        <div class="cart-plus-minus">
                                    ...
                                    <div class="col-xl-3 col-md-4 col-sm-6">
                                        <div class="sp-product-item mb-20">
                                            <div class="sp-product-thumb">
                                                <span class="batch discount">25%</span>
                                                <a href="/shop-details"><img src="img/product/sp_products05.png" alt=""></a>
                                            </div>
                                            <div class="sp-product-content">
                                                <div class="rating">
                                                    <i class="fas fa-star"></i>
                                                ...
                                                <h6 class="title"><a href="/shop-details">Black Lady Vanla Greek Grapes</a></h6>
                                                <span class="product-status">IN Stock</span>
                                                <div class="sp-cart-wrap">
                                                    <form action="#">
                                                        <div class="cart-plus-minus">
                                    ...
                                    <div class="col-xl-3 col-md-4 col-sm-6">
                                        <div class="sp-product-item mb-20">
                                            ...
                                            <div class="sp-product-content">
                                                ...
                                                <h6 class="title"><a href="/shop-details">Potato Max Vanla Greek Pice</a></h6>
                                                <span class="product-status">IN Stock</span>
                                                <div class="sp-cart-wrap">
                                                    <form action="#">
                                                        <div class="cart-plus-minus">
                                    ...
                                    <div class="col-xl-3 col-md-4 col-sm-6">
                                        <div class="sp-product-item mb-20">
                                            <div class="sp-product-thumb">
                                                ...
                                                <a href="/shop-details"><img src="img/product/sp_products07.png" alt=""></a>
                                            </div>
                                            <div class="sp-product-content">
                                                <div class="rating">
                                                    <i class="fas fa-star"></i>
                                    ...
                                    <div class="col-xl-3 col-md-4 col-sm-6">
                                        <div class="sp-product-item mb-20">
                                            <div class="sp-product-thumb">
                                                <span class="batch discount">10%</span>
                                                <a href="/shop-details"><img src="img/product/sp_products08.png" alt=""></a>
                                            </div>
                                            <div class="sp-product-content">
                                                <div class="rating">
                                                    <i class="fas fa-star"></i>
                                                ...
                                                <h6 class="title"><a href="/shop-details">Organic Rice Max Greek Pice</a></h6>
                                                <span class="product-status">IN Stock</span>
                                                <div class="sp-cart-wrap">
                                                    <form action="#">
                                                        <div class="cart-plus-minus">
                        ...
                        <div class="row justify-content-center">
                            <div class="col-3">
                                <div class="sp-product-item mb-20">
                                    <div class="sp-product-thumb">
                                        <span class="batch">New</span>
                                        <a href="/shop-details"><img src="img/product/sp_products09.png" alt=""></a>
                                    </div>
                                    <div class="sp-product-content">
                                        <div class="rating">
                                            <i class="fas fa-star"></i>
                                        ...
                                        <h6 class="title"><a href="/shop-details">Uncle Orange Vanla Ready Pice</a></h6>
                                        <span class="product-status">IN Stock</span>
                                        <div class="sp-cart-wrap">
                                            <form action="#">
                                                <div class="cart-plus-minus">
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="discount-item-two">
                                ...
                                <div class="discount-content">
                                    <span>healthy food</span>
                                    <h4 class="title"><a href="/shop">organic farm for ganic</a></h4>
                                    <p>Super Offer TO 50% OFF</p>
                                    <a href="/shop" class="btn rounded-btn">shop now</a>
                                </div>
                            </div>
                                ...
                                <div class="footer-contact-list">
                                    <ul>
                                        ...
                                        <li>
                                            ...
                                            <p><a href="/cdn-cgi/l/email-protection#0b787e7b7b64797f4b7d6e6c6e6525686466"><span class="__cf_email__" data-cfemail="a0d3d5d0d0cfd2d4e0d6c5c7c5ce8ec3cfcd">[email&#160;protected]</span></a></p>
                                        </li>
                                        <li>
                            ...
                            <div class="footer-widget mb-50">
                                ...
                                <div class="fw-link">
                                    <ul>
                                        ...
                                        <li><a href="/shop">International Shipping</a></li>
                                        <li><a href="/checkout">Payment Method</a></li>
                                        <li><a href="/terms-conditions">Orders and Returns</a></li>
                                        <li><a href="/checkout">Track Your Orders</a></li>
                            ...
                            <div class="footer-widget footer-box-widget mb-50">
                                <div class="f-download-wrap">
                                    ...
                                    <div class="download-btns">
                                        <a href="/"><img src="img/icon/g_play.png" alt=""></a>
